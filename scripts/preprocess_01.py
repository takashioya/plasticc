...
def main():
    ...
    ts_convert_dict = {'detected': np.uint8, 'passband': np.uint8, 'object_id' : np.int32, 'mjd' : np.float64, 'flux' : np.float32, 'flux_err' : np.float32}
    ...
    meta_convert_dict  = {'object_id' : np.int32, 'ra' : np.float32, 'decl' : np.float32, 'gal_l' : np.float32, 'gal_b' : np.float32, 'ddf' : np.uint8, 
                                           'hostgal_specz' : np.float32, 'hostgal_photoz' : np.float32, 'hostgal_photoz_err' : np.float32, 'distmod' : np.float32, 
                                           'mwebv' : np.float32}
